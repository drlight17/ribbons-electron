...
|-------------|--------------|---------------------------------------------------|----------------|
| 🖥 Windows x64   | `.exe`       | [Download](https://github.com/drlight17/ribbons-electron/releases/download/0.1.1-alpha/Ribbons.screensaver.Setup.0.1.1-alpha.exe)   | 80.4 MB          |
| 🐧 Debian/Ubuntu Linux x64    | `.deb`       | [Download](https://github.com/drlight17/ribbons-electron/releases/download/0.1.1-alpha/ribbons-electron_0.1.1-alpha_amd64.deb)     | 77.2 MB          |
| 🐧 RHEL/Fedora Linux x64    | `.rpm`       | [Download](https://github.com/drlight17/ribbons-electron/releases/download/0.1.1-alpha/ribbons-electron-0.1.1-alpha.x86_64.rpm)    | 77.7 MB          |
| 🐧 Linux AppImage x64   | `.AppImage`       | [Download](https://github.com/drlight17/ribbons-electron/releases/download/0.1.1-alpha/Ribbons.screensaver-0.1.1-alpha.AppImage)     | 107 MB          |
| 🌐 Linux Archive x64      | `.tar.gz`       | [Download](https://github.com/drlight17/ribbons-electron/releases/download/0.1.1-alpha/ribbons-electron-0.1.1-alpha.tar.gz)      | 102 MB          |
| 🌐 Windows Archive x64      | `.zip`       | [Download](https://github.com/drlight17/ribbons-electron/releases/download/0.1.1-alpha/Ribbons.screensaver-0.1.1-alpha-win.zip)       | 106 MB          |
